Pod::Spec.new do |spec|
  ...
  spec.source = { :git => "https://github.com/dmrepos/aws-mobilehub-helper-ios.git", :branch => "master", :tag => "v0.0.1" }
  ...
  spec.dependency "AWSSNS", "2.13.2"
  spec.dependency "AWSS3", "2.13.2"
  spec.dependency "AWSLambda", "2.13.2"
  spec.dependency "AWSCore", "2.13.2"
